...
public class LORAqacER extends Base {
    LoginPage loginPage;
    HEProgram myProgram;
    DDActions ddActions;
    PCActions pcActions;
...
//        pcActions.getOkButton().get(0).click();
    ...
    @Test(description = "Revise and Submit by provider ",
    ...
    @Test(description = "PC send the revise application to AQAC again",
