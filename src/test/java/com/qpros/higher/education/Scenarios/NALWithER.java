...
public class NALWithER extends Base {
    LoginPage loginPage;
    HEProgram myProgram;
    DDActions ddActions;
    PCActions pcActions;
...
//           retryAnalyzer = RetryAnalyzer.class,priority = 0)
    ...
    @Test(description = "Send NAL without payment by PC",
            retryAnalyzer = RetryAnalyzer.class, priority = 15)
    public void sendNALWithoutPayment() throws Exception {
...
//        pcActions.getOkButton().get(0).click();
    ...
    public void getProgramStatus() throws Exception {
        ...
        Assert.assertTrue(myProgram.
                getProgramStatusField().getText().equalsIgnoreCase("Unauthorized"));
