...
import com.qpros.higher.education.client.providor.SubstantiveChangeTest;
...
public class SubProviderNameWithERTest extends Base {
    LoginPage loginPage;
    DDActions ddActions;
    PCActions pcActions;
    ERActions erActions;
    ...
    @Test(description = "Change  provider name  for existing provider/ Substantive change tab ",
            retryAnalyzer = RetryAnalyzer.class, priority = 0)
    public void submitSubChaneProviderName() throws Exception {
        ...
        Assert.assertTrue(substantiveChangePage.getThankYou().isDisplayed());
